...
import { EstimatePreviewPanel } from "@/features/documents/components/estimate-preview-panel";
...
export function EstimatesDashboard() {
  ...
  const draftCount = estimates.filter((estimate) => estimate.is_draft).length;
  ...
  return (
    <div className="w-full text-left">
      {selectedId !== null ? (
        <ResizableSplit
          storageKey="erp-estimate-preview-width"
          left={<EstimateListPane />}
          right={
        ...
        <div className="min-w-0 space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select an estimate to preview, print, or download PDF.
              </CardDescription>
            </CardHeader>
                      ...
                      filteredEstimates.map((estimate) => (
                        <TableRow
                          ...
                          className={`cursor-pointer transition-colors hover:bg-muted/50 ${
                            selectedId === estimate.id ? "bg-muted/70" : ""
                          }`}
                        ...
                        >
                          ...
                          <TableCell>
                            <Badge
                              variant={
                                estimate.is_draft ? "secondary" : "default"
                              }
                              className={
                                estimate.is_draft
                                  ? ""
